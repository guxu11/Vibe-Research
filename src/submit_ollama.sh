...
echo "🚀 Running Python script with params: ${SLURM_ARRAY_TASK_ID} " | tee -a make_summaries.log
python3 -u make_summaries.py ${SLURM_ARRAY_TASK_ID}  2>&1 | tee -a make_summaries.log
